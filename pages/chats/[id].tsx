        ...
        <div className='flex flex-col h-screen pb-28'>
          ...
          <div className='overflow-scroll flex-1 p-2 relative'>
            ...
            <div className='flex flex-col items-end w-full'>
              <div className='text-xs'>User</div>
              <div className='rounded-md rounded-tr-none p-2 bg-blue-500 text-white'>
          ...
          <div className='border-t-2 p-2 flex items-center gap-3 self-stretch justify-self-end'>
            <input
              ...
              className='rounded-full flex-1 bg-white p-2 focus:outline-none border-2 focus:bg-slate-100'
            />
            <button className='rounded-full bg-blue-500 text-white p-2 flex items-center justify-center w-10 h-10'>
              <AiOutlineSend />
            </button>
          </div>
        </div>
